...
//get access token
var app_id = '733382153373748';
var secret_id = '7e5769366390e2de94b5d0cff3250e1e';
var access_token_url = "https://graph.facebook.com/oauth/access_token?format=json&callback=accessCallback&client_id="+app_id+"&client_secret="+secret_id+"&grant_type=client_credentials";
// makeJSONPRequest(access_token_url,'access-url');
...
submitButton.onclick = function(){
	...
	//var access_token = "733382153373748|aHj36FB2V9uJLqBM9B__q19bM3E"; // my access token here
...
function accessCallback(jsonData){
